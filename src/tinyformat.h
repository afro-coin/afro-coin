...
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Afrocoin Core
#include <util/string.h> // Added for Afrocoin Core
...
// Added for Afrocoin Core. Wrapper for checking format strings at compile time.
