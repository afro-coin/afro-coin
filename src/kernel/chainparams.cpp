...
// Copyright (c) 2009-2021 The Afrocoin Core developers
...
public:
    CMainParams() {
        ...
        consensus.reserveScriptPubKey = CScript() << OP_DUP << OP_HASH160 << ParseHex(RESERVE_ADDRESS) << OP_EQUALVERIFY << OP_CHECKSIG;
