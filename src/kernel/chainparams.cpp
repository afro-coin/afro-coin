...
public:
    CMainParams() {
        ...
        consensus.nSubsidyDoublingInterval = 2100000;
        consensus.script_flag_exceptions.emplace( // BIP16 exception
            uint256{"00000000000002dc756eebf4f49723ed8d30cc28a5f108eb94b1ba88ac4f9c22"}, SCRIPT_VERIFY_NONE);
        consensus.script_flag_exceptions.emplace( // Taproot exception
            uint256{"0000000000000000000f14c35b2d841e986ab5441de8c585d5ffe55ea1e395ad"}, SCRIPT_VERIFY_P2SH | SCRIPT_VERIFY_WITNESS);
        consensus.BIP34Height = 675;
        consensus.BIP34Hash = uint256{"00000000120daf41731d93701f26a4ddf76272fe341db900fbe8ff1638e7de09"};
        consensus.BIP65Height = 675;             // 00000000120daf41731d93701f26a4ddf76272fe341db900fbe8ff1638e7de09
        consensus.BIP66Height = 675;             // 00000000120daf41731d93701f26a4ddf76272fe341db900fbe8ff1638e7de09
        consensus.CSVHeight = 675;               // 00000000120daf41731d93701f26a4ddf76272fe341db900fbe8ff1638e7de09
        consensus.SegwitHeight = 700;         // 0000000000000000001c8018d9cb3b742ef25114f27563e3fc4a1902167f9893
        consensus.MinBIP9WarningHeight = 700; // segwit activation height + miner confirmation window
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartTime = 1732856400; // November 29, 2024
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeout = 1735534800;   // December 30, 2024
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].min_activation_height = 800; 

        consensus.nMinimumChainWork = uint256{"000000000000000000000000000000000000000000000000000001af01af01af"};
        consensus.defaultAssumeValid = uint256{"00000000a94238d21a61dae00a9ef4946f130fd8a2b48536f52addb55885eac4"}; // 0
        ...
        genesis = CreateGenesisBlock(1231006505, 2083236893, 0x1d00ffff, 1, 5000000000);
        ...
        //vSeeds.emplace_back("seed.afrocoin.sipa.be."); // Pieter Wuille, only supports x1, x5, x9, and xd
        //vSeeds.emplace_back("dnsseed.bluematt.me."); // Matt Corallo, only supports x9
        //vSeeds.emplace_back("dnsseed.afrocoin.dashjr-list-of-p2p-nodes.us."); // Luke Dashjr
        //vSeeds.emplace_back("seed.afrocoin.jonasschnelli.ch."); // Jonas Schnelli, only supports x1, x5, x9, and xd
        //vSeeds.emplace_back("seed.afc.petertodd.net."); // Peter Todd, only supports x1, x5, x9, and xd
        //vSeeds.emplace_back("seed.afrocoin.sprovoost.nl."); // Sjors Provoost
        //vSeeds.emplace_back("dnsseed.emzy.de."); // Stephan Oeste
        //vSeeds.emplace_back("seed.afrocoin.wiz.biz."); // Jason Maurice
        ...
        chainTxData = ChainTxData{
            ...
            // 000000009bf52b3deccb33010145cbdccbfac6f8408198b39dd07c0d9e622d59
            .nTime = 1732862981,
            .tx_count = 4098,
            .dTxRate = 0.5167802170073177,
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1296688602, 414098458, 0x1d00ffff, 1, 5000000000);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.emplace_back("testnet-seed.afrocoin.jonasschnelli.ch.");
        vSeeds.emplace_back("seed.tafc.petertodd.net.");
        vSeeds.emplace_back("seed.testnet.afrocoin.sprovoost.nl.");
...
public:
    CTestNet4Params() {
        ...
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("seed.testnet4.afrocoin.sprovoost.nl."); // Sjors Provoost
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.afrocoin.sprovoost.nl.");
        ...
        genesis = CreateGenesisBlock(1598918400, 52613770, 0x1e0377ae, 1, 5000000000);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.signet_blocks = false;
        consensus.signet_challenge.clear();
        consensus.nSubsidyDoublingInterval = 150;
        ...
        genesis = CreateGenesisBlock(1296688602, 2, 0x207fffff, 1, 5000000000);
        consensus.hashGenesisBlock = genesis.GetHash();
