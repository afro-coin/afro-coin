...
//! Discourage users to set fees higher than this amount (in cents) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in cents)
...
public:
     ...
     * afrocoin-wallet tool code or by wallet migration code. If this is called
    ...
    /** Absolute maximum transaction fee (in cents) used by default for the wallet */
