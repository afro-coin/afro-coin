// Copyright (c) 2014-2020 The Afrocoin Core developers
...
/**
 * CBaseChainParams defines the base parameters (shared between afrocoin-cli and afrocoind)
 * of a given instance of the Afrocoin system.
 */
