// Copyright (c) 2011-2021 The Afrocoin Core developers
...
/** Afrocoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AfrocoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AfrocoinUnits(QObject *parent);

    /** Afrocoin units.
      @note Source: https://en.afrocoin.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        AFC,
        mAFC,
...
typedef AfrocoinUnits::Unit AfrocoinUnit;
