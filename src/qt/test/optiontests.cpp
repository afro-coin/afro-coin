...
{
    // Test regression https://github.com/afrocoin/afrocoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/afrocoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/afrocoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Afrocoin/Afrocoin-Qt.conf and all else left as default,
    // afrocoin-qt should set both -listen and -listenonion to false and start successfully.
