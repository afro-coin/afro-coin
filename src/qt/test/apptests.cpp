...
//! Entry point for AfrocoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &AfrocoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for AfrocoinGUI tests.
void AppTests::guiTests(AfrocoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &AfrocoinGUI::consoleShown, this, &AppTests::consoleTests);
