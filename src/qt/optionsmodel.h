...
/** Interface from Qt to configuration data structure for Afrocoin client.
...
public:
    ...
    AfrocoinUnit getDisplayUnit() const { return m_display_afrocoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSAFControls() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    AfrocoinUnit m_display_afrocoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(AfrocoinUnit unit);
