      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->afrocoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->afrocoinAtStartup);
    ...
    ui->afrocoinAtStartup->setToolTip(ui->afrocoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->afrocoinAtStartup->setText(ui->afrocoinAtStartup->text().arg(CLIENT_NAME));

    ui->openAfrocoinConfButton->setToolTip(ui->openAfrocoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new AfrocoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->afrocoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSAFControls);
...
void OptionsDialog::on_openAfrocoinConfButton_clicked()
{
