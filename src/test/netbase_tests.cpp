...
{
    BOOST_CHECK(TestSplitHost("www.afrocoincore.org", "www.afrocoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.afrocoincore.org]", "www.afrocoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.afrocoincore.org:80", "www.afrocoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.afrocoincore.org]:80", "www.afrocoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.afrocoincore.org:65536", "www.afrocoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.afrocoincore.org:0", "www.afrocoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.afrocoincore.org:", "www.afrocoincore.org:", 0, false));
}
