...
**When configuring Afrocoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Afrocoin Core:
...
variables will be set when generating the Afrocoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
