...
"""Example logging Afrocoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/afrocoind
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[afrocoind_with_usdts])
