...
declare -A LIBS
LIBS[cli]="libafrocoin_cli.a"
LIBS[common]="libafrocoin_common.a"
LIBS[consensus]="libafrocoin_consensus.a"
LIBS[crypto]="crypto/libafrocoin_crypto.a crypto/libafrocoin_crypto_x86_shani.a crypto/libafrocoin_crypto_sse41.a crypto/libafrocoin_crypto_avx2.a"
LIBS[node]="libafrocoin_node.a"
LIBS[util]="util/libafrocoin_util.a"
LIBS[wallet]="wallet/libafrocoin_wallet.a"
...
# https://github.com/afrocoin/afrocoin/issues/10102
