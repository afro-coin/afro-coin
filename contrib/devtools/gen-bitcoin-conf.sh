...
BITCOIND=${BITCOIND:-$BINDIR/afrocoind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/afrocoin.conf}
...
then
  ...
  echo -e "To safely generate a afrocoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example afrocoin.conf file in share/examples/'
...
##
## afrocoin.conf configuration file.
## Generated by contrib/devtools/gen-afrocoin-conf.sh.
##
...
# parse the output from afrocoind --help
