...
(define* (make-afrocoin-cross-toolchain target
                                       #:key
...
desirable for building Afrocoin Core release binaries."
...
;; failure; see https://github.com/afrocoin/afrocoin/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-afrocoin-cross-toolchain target)))
