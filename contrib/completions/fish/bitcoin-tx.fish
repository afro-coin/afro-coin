...
# Extract options
function __fish_afrocoin_tx_get_options
...
# Extract commands
function __fish_afrocoin_tx_get_commands
...
complete \
    --command afrocoin-tx \
    --condition "not __fish_afrocoin_seen_cmd (__fish_afrocoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_afrocoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command afrocoin-tx \
    --arguments "(__fish_afrocoin_tx_get_commands)" \
    --no-files
