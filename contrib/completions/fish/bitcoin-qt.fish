...
complete --command afrocoin-qt --no-files

# Extract options
function __fish_afrocoinqt_get_options
...
complete \
    --command afrocoin-qt \
    --arguments "(__fish_afrocoinqt_get_options --nofiles)"
