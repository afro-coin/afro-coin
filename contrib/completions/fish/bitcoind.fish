...
complete --command afrocoind --no-files

# Extract options
function __fish_afrocoind_get_options
...
complete \
    --command afrocoind \
    --arguments "(__fish_afrocoind_get_options --nofiles)"
