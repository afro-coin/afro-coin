...
# The block reward of coinbaseoutput.nValue (50) AFC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 AFC/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"afrocoin-cli -h\" for help or \"afrocoin-cli listwallets\" to see "
...
class TestAfrocoinCli(AfrocoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `afrocoin-cli getblockchaininfo`")
        ...
        # Prevent afrocoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and afrocoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and afrocoin-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (AFC/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (AFC/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 AFC) to the default wallet.
            ...
            # Test afrocoin-cli -generate with -rpcwallet in multiwallet mode.
