...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/afrocoin/afrocoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(AfrocoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our afrocoind node")
