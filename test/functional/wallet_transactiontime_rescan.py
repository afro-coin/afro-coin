...
class TransactionTimeRescanTest(AfrocoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine AFC and create transactions
        ...
        # generate some afc to create transactions and check blockcount
        ...
        # send 10 afc to user's first watch-only address
        self.log.info('Send 10 afc to user')
        ...
        # send 5 afc to our second watch-only address
        self.log.info('Send 5 afc to user')
        ...
        # send 1 afc to our third watch-only address
        self.log.info('Send 1 afc to user')
