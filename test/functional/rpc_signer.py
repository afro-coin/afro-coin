...
Verify that a afrocoind node can use an external signer command.
...
class RPCSignerTest(AfrocoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart afrocoind with -signer=<cmd>',
