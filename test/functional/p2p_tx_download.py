#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Afrocoin Core developers
...
class TxDownloadTest(AfrocoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new afrocoind instances, as setting mocktimes has long-term effects on when
