#!/usr/bin/env python3
# Copyright (c) 2020-present The Afrocoin Core developers
...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The afrocoind node closes feeler connections as soon as a version
...
class P2PAddConnections(AfrocoinTestFramework):
    ...
    def run_test(self):
        ...
        # afrocoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that afrocoind sends its own version prior to processing
