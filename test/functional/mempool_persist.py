...
By default, afrocoind will dump mempool on shutdown and
...
class MempoolPersistTest(AfrocoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent afrocoind from writing mempool.dat to disk. Verify that `savemempool` fails")
