...
class TxnMallTest(AfrocoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 AFC:
        ...
        # First: use raw transaction API to send 1240 AFC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 AFC coin each
        ...
        # Node0's balance should be starting balance, plus 50AFC for another
        ...
        # Node0's total balance should be starting balance, plus 100AFC for
