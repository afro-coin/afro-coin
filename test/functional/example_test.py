...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AfrocoinTestFramework
    pass


class ExampleTest(AfrocoinTestFramework):
    # Each functional test is a subclass of the AfrocoinTestFramework class.
    ...
    def custom_method(self):
        ...
        AfrocoinTestFramework class so other tests can use it."""
