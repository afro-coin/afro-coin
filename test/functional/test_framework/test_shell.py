...
class TestShell:
    """Wrapper Class for AfrocoinTestFramework.

    The TestShell class extends the AfrocoinTestFramework
    ...
    class __TestShell(AfrocoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by AfrocoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # AfrocoinTestFramework instances are supposed to be constructed with the path
