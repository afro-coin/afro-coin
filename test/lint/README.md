...
```sh
DOCKER_BUILDKIT=1 docker build -t afrocoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/afrocoin -it afrocoin-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/afrocoin-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/afrocoin-core/leveldb-subtree.git (branch afrocoin-fork)
* for `src/crypto/ctaes`: https://github.com/afrocoin-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/afrocoin-core/crc32c-subtree.git (branch afrocoin-fork)
* for `src/minisketch`: https://github.com/sipa/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/afrocoin-core/secp256k1.git
```
