...
```sh
cmake --build build --target afrocoind afrocoin-cli
cmake --build build --target afrocoin-qt
cmake --build build --target bench_afrocoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:afrocoin/afrocoin.git
```
