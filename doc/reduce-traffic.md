...
By default, Afrocoin Core allows up to 125 connections to different peers, 11 of
...
limits are tiny. Keep in mind that afrocoin's trustless model works best if you are
