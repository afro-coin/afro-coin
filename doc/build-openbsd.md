...
This guide describes how to build afrocoind, command-line utilities, and GUI on OpenBSD.
...
...
to: /path/to/afrocoin/depends/*-unknown-openbsd*
```
...
(see issue [#6658](https://github.com/afrocoin/afrocoin/issues/6658)).
