Afrocoin Core version 0.16.1 is now available from:

  <https://afrocoincore.org/bin/afrocoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting afrocoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure afrocoind processes are cleaned up when tests end (sdaftuar)
