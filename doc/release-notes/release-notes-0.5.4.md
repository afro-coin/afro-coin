Afrocoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/afrocoin/files/Afrocoin/afrocoin-0.5.4/
...
http://gitorious.org/afrocoin/afrocoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Afrocoin-Qt notifications under Growl 1.3.
Increase required age of Afrocoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAfrocoin properly when installing Afrocoin-Qt over it. (Windows)
