Afrocoin Core version 0.13.2 is now available from:

  <https://afrocoin.org/bin/afrocoin-core-0.13.2/>
...
- #8908 `4a974b2` Update afrocoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow afrocoin-tx to create v2 transactions (afcdrak)
