Afrocoin Core version *0.15.2* is now available from:

  <https://afrocoincore.org/bin/afrocoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in afrocoin-tx (TheBlueMatt)
