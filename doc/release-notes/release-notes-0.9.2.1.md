Afrocoin Core version 0.9.2.1 is now available from:

  https://afrocoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 AFC to 0.01 AFC
...
- Fix "Start afrocoin on system login"
