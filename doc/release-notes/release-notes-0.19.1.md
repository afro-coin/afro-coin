...
Afrocoin Core version 0.19.1 is now available from:

  <https://afrocoincore.org/bin/afrocoin-core-0.19.1/>
...
From Afrocoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Afrocoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Afrocoin Core does not yet change appearance when
...
- #17488 fix "afrocoind already running" warnings on macOS (fanquake)
