Afrocoin Core version 0.9.4 is now available from:

  https://afrocoin.org/bin/0.9.4/
...
this update is incompatible with the Afrocoin system and could lead to consensus
forks.

Afrocoin Core released binaries from https://afrocoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~afrocoin/+archive/ubuntu/afrocoin
- A third-party or self-compiled Afrocoin Core

upgrade to Afrocoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
