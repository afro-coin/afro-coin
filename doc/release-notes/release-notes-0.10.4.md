Afrocoin Core version 0.10.4 is now available from:

  <https://afrocoin.org/bin/afrocoin-core-0.10.4/>
...
- #6953 `43c2789` Split afrocoin-tx into its own package
- #6953 `dfe0d4d` Include afrocoin-tx binary on Debian/Ubuntu
