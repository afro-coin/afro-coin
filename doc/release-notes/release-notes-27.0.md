Afrocoin Core version 27.0 is now available from:

  <https://afrocoincore.org/bin/afrocoin-core-27.0/>
...
libafrocoinconsensus
-------------------

- libafrocoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libafrocoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Afrocoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Afrocoin Core would
