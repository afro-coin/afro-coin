Afrocoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/afrocoin/files/Afrocoin/afrocoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Afrocoin
...
New/changed settings (command-line or afrocoin.conf file)
--------------------------------------------------------
