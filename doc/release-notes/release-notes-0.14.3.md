Afrocoin Core version *0.14.3* is now available from:

  <https://afrocoin.org/bin/afrocoin-core-0.14.3/>
...
Afrocoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
the vulnerable versions to 0.14.3, 0.15.2 or 0.16.3 as soon as possible.

Known Bugs
==========

Since 0.14.0 the approximate transaction fee shown in Afrocoin-Qt when using coin
...
- #10451 `3612219` contrib/init/afrocoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
