...
Assumeutxo is a feature that allows fast bootstrapping of a validating afrocoind
instance.
...
```
$ afrocoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ afrocoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
